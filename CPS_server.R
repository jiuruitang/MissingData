...
pop_sd_HT <- sqrt(sum((sub_dat$X1/sub_dat$pi)^2*(1-sub_dat$pi)))/V_adj  # HT estimator of population total
...
save(resultListMAR,resultListANWC,sub_dat,ratio,MI_dataANWC, MI_dataMAR, file = paste("./results2/Mis_",run_index,".RData",sep=""))
